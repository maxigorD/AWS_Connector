...
from ETL.common.constants import S3FileTypes
from ETL.common.custom_exceptions import WrongFormatException
...
class S3BucketConnector():
    ...
    def __init__(self, access_key: str, secret_key: str, endpoint_url: str, bucket: str):
        ...
        self.s3_custom = boto3.resource('s3')
        self._bucket = self.s3_custom.Bucket(bucket)
