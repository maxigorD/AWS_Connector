...
from ETL.transformers.xetra_transformer import XetraETL, XetraSourceConfig, XetraTargetConfig
...
class IntTestXetraETLMethods(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.s3_bucket_name_src = 'etl-int-test-src'
        self.s3_bucket_name_trg = 'etl-int-test-trg'
